                        ...
                        <TabsContent value="cookie-policy" className="mt-4 space-y-4">
                            <div className="space-y-4">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    ...
                                    media, and advertisements. We use cookies for various purposes including:
                                </p>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Your cookie preferences will be stored for {COOKIE_EXPIRATION_DAYS} days, after which you will be
                                        asked to confirm your choices again.
                                    </p>
                                </div>
                            </div>
                        </TabsContent>
