                ...
                >
                    ...
                    <CardContent>
                        <p className="text-sm text-muted-foreground">
                            Issued: {new Date(certificate.date).toLocaleDateString("en-US", { year: "numeric", month: "long" })}
                        </p>
                    </CardContent>
                    <CardFooter>
                        {certificate.link ? (
                            <Link href={certificate.link} target="_blank" rel="noopener noreferrer" className="w-full">
