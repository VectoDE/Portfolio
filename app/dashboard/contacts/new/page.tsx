                    ...
                    <CardContent className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input id="name" name="name" placeholder="Contact name" className="pl-10" required />
                            </div>
                        </div>
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input id="email" name="email" type="email" placeholder="Contact email" className="pl-10" required />
                            </div>
                        </div>
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input id="subject" name="subject" placeholder="Message subject" className="pl-10" required />
                            </div>
                        </div>
                        <div className="space-y-2">
