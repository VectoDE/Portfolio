...
export async function GET(req: Request) {
    try {
        ...
        const [projectStats, certificateStats, skillStats, careerStats, contactStats, pageViewStats] = await Promise.all([
        ...
        const [projectDaily, certificateDaily, skillDaily, careerDaily, contactDaily] = await Promise.all([
